...
# Test GET request for searching orders by product name
response = requests.get(BASE + "ordersearch/Widget A", headers=headers)
print("GET /ordersearch/Widget A:", response.json())

# Optionally, you can test searching with partial names or other variations
response = requests.get(BASE + "ordersearch/Widget", headers=headers)
print("GET /ordersearch/Widget:", response.json())
